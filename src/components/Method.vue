<template>
    ...
    <v-row class="justify-center align-center flex-column flex-lg-row ga-4">
      <v-col   class="payment-method align-center d-flex flex-column"   v-if="!showHowToInvest" v-for="(item, index) in items" :key="index" cols="12" lg="2">
        <img
       
          :src="item.image"
          class="rounded-image"
          @click="openHowToInvest(index)"
        ></img>
      ...
      <v-col v-if="showHowToInvest" cols="12">
        ...
        <HowtoInvest
          :app_heading="heading[selectedItem]"
          :app_subheading="subHeading[selectedItem]"
          :images1="images1[selectedItem] || []"
          :points1="points1[selectedItem] || []"
          :images2="images2[selectedItem] || []"
          :points2="points2[selectedItem] || []"
        />
      </v-col>
    </v-row>
  </template>
